...
import { runPosSaleFlow } from "../../regression/harness/pos-sale-flow.js";
...
test.describe("POS Restaurant — Sales with Customer Assignment @release", () => {
  requirePosCredentials(test);

  test("validates all customer assignment methods and completes the sale", async ({ posRestaurantPage: page }) => {
