...
export async function fillPaymentDetailsAndSubmit(page, { paymentAmount, paymentDescription }) {
...
export async function validateInitialDeletionError(page, { initialDeleteReason }) {
...
export async function confirmFinalDeletion(page, { finalDeleteReason }) {
...
export async function printPaymentTicket(page, { paymentAmount }) {
