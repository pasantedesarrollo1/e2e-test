...
export async function selectTable(page: Page): Promise<string> {
...
export async function searchAndSelectProduct(page: Page, productName: string | RegExp): Promise<void> {
  ...
  await searchbar.fill(typeof productName === 'string' ? productName : productName.source);
...
export async function printPreticket(page: Page): Promise<void> {
