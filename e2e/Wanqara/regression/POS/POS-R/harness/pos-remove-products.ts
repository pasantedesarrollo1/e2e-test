...
export async function navigateToRemoveProducts(page: Page): Promise<void> {
...
export async function selectProductToRemove(page: Page, productName: string): Promise<void> {
...
export async function confirmProductRemoval(page: Page): Promise<void> {
