...
import { completePayment } from "../payments/pos-payment.js";
import { searchAndSelectProduct } from "../products/pos-search.js";
import { captureSaleMutation } from '../sales/pos-checkout-helpers.js';

export async function finalizeSaleAndAssert(page, { precision, multiProduct = false, paymentMethod }) {
