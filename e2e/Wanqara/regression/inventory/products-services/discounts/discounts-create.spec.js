...
import { createDiscount } from "./harness/discount-helpers.js";

import scenarios from "./0-json-data/discounts-create.json" assert { type: "json" };

test.describe("Inventory - Discounts (Create)", () => {
  ...
  for (const scenario of scenarios) {
    ...
    describeBlock(`Escenario: ${scenario.description} ${executionTag}`, () => {
      ...
      test(`ensures discount '${scenario.discountData.name}' is created successfully`, async ({ page }) => {
