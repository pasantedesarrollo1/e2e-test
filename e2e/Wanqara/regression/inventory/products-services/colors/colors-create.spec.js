...
import { createColor } from "./harness/color-helpers.js";

import scenarios from "./0-json-data/colors-create.json" assert { type: "json" };

test.describe("Inventory - Colors (Create)", () => {
  ...
  for (const scenario of scenarios) {
    ...
    describeBlock(`Escenario: ${scenario.description} ${executionTag}`, () => {
      ...
      test(`ensures color '${scenario.colorData.name}' is created successfully`, async ({ page }) => {
