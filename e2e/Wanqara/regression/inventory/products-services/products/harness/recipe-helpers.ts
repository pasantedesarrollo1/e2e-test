...
export interface VerifyRecipeDecimalsOptions {
  productName: string;
  ingredientName: string;
  exactAmount: string | RegExp;
  roundedAmount: string | RegExp;
}

export async function navigateToProductAndVerifyRecipeDecimals(page: Page, {
  productName,
  ingredientName,
  exactAmount,
  roundedAmount
}: VerifyRecipeDecimalsOptions): Promise<void> {
