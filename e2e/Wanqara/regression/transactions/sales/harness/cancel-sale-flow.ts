...
export async function cancelFirstSaleAndVerify(page: Page, { expectSwitch, expectMessage, confirmCancellation = true, annulmentReason = "Anulación automatizada por E2E" }: CancelFirstSaleOptions): Promise<void> {
