...
export async function selectFirstCategory(page: Page): Promise<void> {
...
export async function selectFirstDateAndSlot(page: Page): Promise<void> {
...
export async function fillWhatsapp(page: Page, number: string): Promise<void> {
  const whatsappInput = page.locator("#whatsapp");
  await expect(whatsappInput).toBeVisible();
  await whatsappInput.fill(number);
}

export async function fillObservation(page: Page, text: string): Promise<void> {
...
export async function checkFormFilledCorrectly(page: Page): Promise<void> {
