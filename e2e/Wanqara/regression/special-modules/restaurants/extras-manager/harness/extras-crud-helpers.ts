...
export async function createExtraCategory(page: Page, categoryName: string): Promise<void> {
...
export async function assignProductsToExtraCategory(page: Page, categoryName: string, productSearchTerm: string, productNamesToSelect: string[]): Promise<void> {
...
export async function verifyDeletionConstraintsAndRemoveProducts(page: Page): Promise<void> {
  ...
  await expect(cannotDeleteWarning).toBeHidden();
...
export async function deleteExtraCategory(page: Page): Promise<void> {
  const deleteCategoryBtn = page.getByRole("button", { name: /Eliminar categor.a/i });
  await expect(deleteCategoryBtn).toBeVisible();
  await deleteCategoryBtn.click();
