...
test.describe("Smoke — Finanzas > Tesorería", { tag: "@smoke" }, () => {
  ...
  generateSmokeTests(tenantBaseUrl, [
    // treasuryHome renders openTreasuryCashRegister or treasuryPayments
    // depending on whether the tenant's treasury register is open, so accept
    // either marker rather than failing whenever it happens to be open.
