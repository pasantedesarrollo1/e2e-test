// e2e/smoke/harness/smoke-assertions.js
...
/**
 * Passes when any one of `texts` is visible. For routes that render a
 * different view per tenant state — asserting a single variant makes the smoke
 * test depend on live data rather than on the route being reachable.
 */
