...
test.describe("POS Retail — Cash Register Income and Expense Transactions @regression", () => {
  requirePosCredentials(test);

  test("records both a cash income and a cash expense from the More Options menu", async ({ posPage: page }) => {
