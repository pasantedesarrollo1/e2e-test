...
import { ensureRetailBusinessType } from "../../../../harness/retail-setup.js";
...
test.describe("POS Retail — Environment Setup", () => {
  test("ensure business type is retail and dispatch is disabled", async ({ page }) => {
    ...
    const retailChanged = await ensureRetailBusinessType(page, { tenantBaseUrl });
    ...
    if (retailChanged || dispatchChanged) {
