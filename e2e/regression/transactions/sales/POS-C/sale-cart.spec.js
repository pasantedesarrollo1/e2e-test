...
test.describe("POS Retail — Cart Operations and Sale Validations @regression", () => {
  ...
  test("prevents final consumer sales exceeding the $50 limit", async ({ posPage: page }) => {
  ...
  test("completes a sale using a receipt document for a standard product", async ({ posPage: page }) => {
